...
*/
(function(){"use strict";function n(){for(var i,u,o,f,r=[],e=0;e<arguments.length;e++)if(i=arguments[e],i)if(u=typeof i,u==="string"||u==="number")r.push(i);else if(Array.isArray(i)&&i.length)o=n.apply(null,i),o&&r.push(o);else if(u==="object")for(f in i)t.call(i,f)&&i[f]&&r.push(f);return r.join(" ")}var t={}.hasOwnProperty;typeof module!="undefined"&&module.exports?(n.default=n,module.exports=n):typeof define=="function"&&typeof define.amd=="object"&&define.amd?define("classnames",[],function(){return n}):window.classNames=n})();
